...
import { distanceBetweenTwoPoints } from "./utils.js";
...
function spawnEnemies() {
	...
	countIntervalId = setInterval(() => countOfSpawnEnemies++, 3000);
	spawnIntervalId = setInterval(
		() => spawnOfCountEnemies(countOfSpawnEnemies),
		1000
	);
	spawnOfCountEnemies(countOfSpawnEnemies);
}

function spawnOfCountEnemies(count) {
